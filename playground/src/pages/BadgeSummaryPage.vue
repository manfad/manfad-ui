  ...
  <div class="space-y-8">
    <Card>
      <CardContent class="space-y-4 p-6">
        <div class="space-y-1">
          <h2 class="text-lg font-semibold">Badge summary</h2>
          <p class="text-sm text-muted-foreground">
            Group label, selected count, and expandable leaf badges.
          </p>
        </div>
