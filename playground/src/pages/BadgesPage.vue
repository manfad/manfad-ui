...
const usage = usageExamples['badges']
...
<CardContent class="space-y-4 p-6">
          ...
          <div class="space-y-2">
            <p class="text-sm text-muted-foreground">Clickable</p>
            <div class="flex flex-wrap items-center gap-2">
              <Badge clickable @click="toast({ title: 'Default clicked' })">Default</Badge>
              <Badge clickable variant="secondary" @click="toast({ title: 'Secondary clicked' })">Secondary</Badge>
              <Badge clickable variant="outline" @click="toast({ title: 'Outline clicked' })">Outline</Badge>
            </div>
          </div>
        </CardContent>
  </Card>
