...
const usage = usageExamples['code-block']
...
<CardContent class="space-y-4 p-6">
          <h2 class="text-lg font-semibold">Code block</h2>
          <p class="text-sm text-muted-foreground">
            Line numbers and light
            <code class="text-xs">//</code> comment styling.
          </p>
          <CodeBlock
            :content="codeBlockSample"
            class="max-w-xl"
          />
        </CardContent>
  </Card>
