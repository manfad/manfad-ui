...
const usage = usageExamples['editable-table']
...
<CardContent class="space-y-4 p-6">
          ...
          <p class="text-sm text-muted-foreground">
            Toggle Edit Mode to turn every editable column into inputs, or double-click a single cell
            (or use its hover pen). Use Cancel to discard drafts, or Save changes to commit them all.
          </p>
          <GroupedTable
            class="[&_table]:table-fixed"
            :groups="stockGroups"
            :rows="stockRows"
            row-key="id"
            @save="onStockSave"
