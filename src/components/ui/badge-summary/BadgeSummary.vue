...
const props = defineProps<{
  ...
  /** Ungrouped leaves, rendered as badges below the groups when selected. */
  items?: CheckboxTreeLeaf[]
  /** Selected leaf values to summarise. */
  values: string[]
  /** Badge shown when nothing is selected. Defaults to "None". */
  emptyLabel?: string
...
/** Groups start expanded so selected badges are visible by default. */
