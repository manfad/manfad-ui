...
const props = withDefaults(defineProps<SidebarSwitcherProps>(), {
  icon: 'i-lucide-boxes',
  placeholder: 'Select…',
...
/** Selecting an item returns focus to the trigger; skip that so the ring doesn’t stick after a pointer switch. */
